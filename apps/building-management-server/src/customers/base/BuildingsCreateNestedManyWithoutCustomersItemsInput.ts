...
@InputType()
class BuildingsCreateNestedManyWithoutCustomersItemsInput {
...
export { BuildingsCreateNestedManyWithoutCustomersItemsInput as BuildingsCreateNestedManyWithoutCustomersItemsInput };
