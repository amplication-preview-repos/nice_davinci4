...
class RentHomesCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ContractsCreateNestedManyWithoutRentHomesItemsInput,
  })
  @ValidateNested()
  @Type(() => ContractsCreateNestedManyWithoutRentHomesItemsInput)
  @IsOptional()
  @Field(() => ContractsCreateNestedManyWithoutRentHomesItemsInput, {
    nullable: true,
  })
  contractsItems?: ContractsCreateNestedManyWithoutRentHomesItemsInput;
}

export { RentHomesCreateInput as RentHomesCreateInput };
